...
Let's analysis this example:
* Prompt: Students should select their majors according to demands in current labor market.
* Task: Give a stand (Strongly disagree - Moderately disagree - Moderately agree - Strongly agree), and provide justifications for the stand.
...
## Final words
In summary, before writing a response in IELTS Task 2, first we need to analyze the provided question to help us understand: (1) The nature of the prompt provided; (2) The tasks we are required to perform; and (3) The type of question posed. For an Opinion essay, you can refer to the suggestions provided above as a guide to structuring your response effectively.
