...
Nếu có một từ khóa để mô tả ngành AI/ML/DL trong những năm gần đây, thì "bùng nổ" chắc chắn là một trong những từ đầu tiên xuất hiện trong đầu nhiều người.

Số lượng bài nộp vào các hội nghị hàng đầu tăng rất nhanh. Nhìn từ bên ngoài, đây có vẻ là một tín hiệu tích cực: cộng đồng mở rộng hơn, nhiều nhóm nghiên cứu mới tham gia hơn, và tốc độ tạo ra tri thức cũng nhanh hơn.
...
- khó được nhận bài hơn.

Điều đó đúng, nhưng chưa đủ.

Điều đáng lo hơn là hệ quả dây chuyền phía sau:

1. **Khó tìm đủ reviewer chất lượng**
2. **Tăng nguy cơ review hời hợt hoặc thiếu chuyên môn phù hợp**
3. **Gia tăng áp lực cho AC, SPC, SAC, và toàn bộ ban chương trình**
4. **Khiến quyết định chấp nhận hoặc từ chối trở nên nhiễu hơn**
5. **Làm suy yếu trải nghiệm học thuật của cả tác giả lẫn người phản biện**

Nói cách khác, khi lượng bài tăng quá nhanh, bài toán không còn chỉ là "lọc ra bài hay", mà là **duy trì chất lượng của chính quá trình đánh giá**.

---

### Vì sao điều này đặc biệt nghiêm trọng trong AI?

Khác với nhiều lĩnh vực khác, AI hiện nay có ít nhất ba đặc điểm khiến vấn đề này trở nên căng hơn.

#### 1. Tốc độ tăng trưởng của cộng đồng quá nhanh

AI hiện không còn là sân chơi của một nhóm nghiên cứu hẹp. Nó đã mở rộng sang rất nhiều hướng: học máy truyền thống, deep learning, multimodal models, LLMs, optimization, scientific machine learning, AI for healthcare, AI safety, robotics, và nhiều nhánh khác.

Sự mở rộng đó là tín hiệu tốt, nhưng nó cũng làm cho việc ghép đúng bài với đúng reviewer ngày càng khó hơn.

#### 2. Động lực công bố ngày càng mạnh

Ở nhiều nơi, số lượng bài báo vẫn là một tín hiệu quan trọng trong tuyển dụng, xin học bổng, xin tài trợ, hoặc thăng tiến.
...
- nơi tuyển dụng,
- nơi kết nối công nghiệp,
- nơi định hình xu hướng nghiên cứu của năm tiếp theo.

Khi quá nhiều chức năng dồn vào cùng một hệ thống, thì chỉ cần một mắt xích quá tải — ví dụ như peer review — toàn bộ cấu trúc sẽ bắt đầu lộ vấn đề.
...
#### 1. Reviewer ngày càng quá tải

Một reviewer giỏi không chỉ cần đọc nhanh. Họ cần đủ thời gian để:

- hiểu bài,
- kiểm tra lập luận,
- đối chiếu với literature,
- đánh giá thí nghiệm hoặc chứng minh,
- và viết phản hồi có trách nhiệm.

Khi tải review quá lớn, chất lượng phần việc này khó tránh khỏi bị ảnh hưởng.

#### 2. Quy trình ngày càng phụ thuộc vào calibration ở quy mô lớn

Khi có quá nhiều bài và quá nhiều reviewer, ban chương trình buộc phải dựa nhiều hơn vào các lớp trung gian như AC, SPC, SAC để hiệu chỉnh quyết định.

Điều này cần thiết, nhưng nó cũng cho thấy hệ thống đang vận hành trong điều kiện rất căng:  
**không chỉ đánh giá bài, mà còn phải liên tục sửa sai cho chính quá trình đánh giá.**

#### 3. Trải nghiệm của tác giả trở nên bất ổn hơn

Nhiều tác giả ngày càng có cảm giác rằng kết quả review phụ thuộc mạnh vào "đúng người đọc được bài của mình hay không".

Dĩ nhiên, peer review chưa bao giờ hoàn hảo. Nhưng khi quy mô tăng quá nhanh, cảm giác bất định này càng lớn hơn.

---

### Đây có phải chỉ là chuyện của tác giả bị reject?
...
- **độ tin cậy của peer review,**
- **sức bền của mô hình hội nghị tập trung,**
- và **chất lượng của tri thức mà cộng đồng đang dùng để xây dựng tiếp.**

Một hệ thống quá tải không chỉ làm người nộp bài mệt mỏi. Nó còn có thể:

- bỏ sót những ý tưởng tốt,
- chấp nhận những bài chưa thật sự chín,
- làm tăng nhiễu trong literature,
- và bào mòn niềm tin của cộng đồng vào cơ chế đánh giá.

---

### Vậy chúng ta nên nhìn chuyện này như thế nào?

Theo mình, có ít nhất ba cách nhìn công bằng hơn.

#### 1. Tăng trưởng không phải lúc nào cũng đồng nghĩa với khỏe mạnh

Một lĩnh vực tăng trưởng quá nhanh có thể rất năng động, nhưng cũng có thể đang tạo ra những áp lực mà hạ tầng học thuật chưa kịp thích nghi.

#### 2. Peer review là một hạ tầng, không phải một tài nguyên vô hạn
...
Nếu hạ tầng này không được mở rộng tương ứng, chất lượng khoa học sẽ khó giữ ổn định.
...
Trong một hệ thống quá tải, đôi khi điều tăng nhanh nhất lại là **nhiễu**.

---

### Kết

Mình không nghĩ sự bùng nổ của AI là điều xấu. Ngược lại, nó phản ánh sức sống rất mạnh của lĩnh vực này.

Nhưng mình cũng nghĩ rằng đã đến lúc cộng đồng cần nhìn thẳng vào một thực tế:

**nếu tốc độ tăng trưởng tiếp tục vượt xa sức chịu đựng của hệ thống phản biện, thì "bùng nổ" sẽ không còn chỉ là dấu hiệu của phát triển — nó có thể trở thành dấu hiệu của quá tải.**
...
- and a smaller chance of getting accepted.
...
3. The burden on ACs, SPCs, SACs, and program chairs grows substantially.
4. Final decisions become noisier.
5. The academic experience deteriorates for both authors and reviewers.

In other words, once submission volume grows too quickly, the challenge is no longer only about **selecting strong papers**. It becomes a question of **preserving the quality of evaluation itself**.

---

### Why this is especially serious in AI

I think this pressure is particularly intense in AI for at least three reasons.
...
That creates enormous pressure to submit — especially to flagship venues such as NeurIPS, ICML, ICLR, and AAAI.
...
- and a signal of what topics matter next.
...
- and write a responsible review.

Once reviewing load becomes too heavy, that quality is difficult to maintain.

#### 2. The process increasingly depends on large-scale calibration

At very high volume, program committees must rely more heavily on ACs, SPCs, and SACs to calibrate decisions across inconsistent reviews.

That may be necessary, but it is also revealing. It means the system is not simply reviewing papers — it is also constantly trying to correct for the noise created by reviewing at scale.

#### 3. The author experience becomes more unstable
...
- and **the quality of the knowledge base the community is building on.**
...
- and gradually weaken trust in the evaluation process itself.
